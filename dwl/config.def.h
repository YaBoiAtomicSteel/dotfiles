...
static uint32_t colors[][3]                = {
	/*               fg          bg          border    */
	[SchemeNorm] = { 0xc0caf5ff, 0x00000080, 0x00000080 },
	[SchemeSel]  = { 0xc0caf5ff, 0x2ac3de80, 0x2ac3deff },
	[SchemeUrg]  = { 0,          0,          0x9ece6aff },
};
...
static const char *const autostart[] = {
	"sh", "-c", "swaybg -i $HOME/.config/dwl/tokyo_torvalds.jpg -m fill", NULL,
        NULL /* terminate */
};
...
static const char *menucmd[] = { "sh", "-c", "j4-dmenu-desktop --dmenu=\"cat | wmenu -bi -f 'JetBrainsMono Nerd Font Mono Bold 10' -N 00000080 -n c0caf5 -M 226f82 -m c0caf5 -S 226f82 -s c0caf5 -p 'Search: '\"", NULL }; // 
...
static const char *snip[] = { "sh", "-c", "grim -g \"$(slurp)\" - | wl-copy -t image/png", NULL };
static const char *prtsc[] = { "sh", "-c", "grim - | wl-copy -t image/png", NULL }; // TODO add multi-monitor selection functionality
...
static const Key keys[] = {
	...
	{ 0, XKB_KEY_XF86SelectiveScreenshot,			  spawn,            {.v = snip} },
